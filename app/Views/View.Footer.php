...
<script src="{{Host}}public/js/core/bootstrap.min.js"></script>

<!--  Plugin for Switches, full documentation here: http://www.jque.re/plugins/version3/bootstrap.switch/ -->
<script src="{{Host}}public/js/plugins/bootstrap-switch.js"></script>
<!--  Plugin for Sweet Alert -->
<script src="{{Host}}public/js/plugins/sweetalert2.min.js"></script>
...
<script src="{{Host}}public/js/plugins/bootstrap-datetimepicker.js"></script>
...
<!-- Chart JS -->
<script src="{{Host}}public/js/plugins/chartjs.min.js"></script>
...
<!-- Perfect Scroll-->
<script src="{{Host}}public/js/plugins/perfect-scrollbar.jquery.min.js"></script>
<!-- Control Center for Now Ui Dashboard: parallax effects, scripts for the example pages etc -->
<script src="{{Host}}public/js/paper-dashboard.min790f.js?v=2.0.1" type="text/javascript"></script>

<!-- Paper Dashboard DEMO methods, don't include it in your project! -->
<script src="{{Host}}public/demo/demo.js"></script>
<script src="{{Host}}public/demo/jquery.sharrre.js"></script>

<script src="{{Host}}public/js/h-smart-thumbnail.min.js"></script>
<script src="{{Host}}public/js/imagesloaded.pkgd.min.js"></script>
<script src="{{Host}}public/js/waitMe.js"></script>

<script src="{{Host}}app/js/script.js"></script>
